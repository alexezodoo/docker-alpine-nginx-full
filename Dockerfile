...
LABEL org.label-schema.schema-version="1.0" \
	...
	org.label-schema.url="https://github.com/alexezodoo/docker-alpine-nginx-full" \
	org.label-schema.vcs-url="https://github.com/alexezodoo/docker-alpine-nginx-full.git" \
	org.label-schema.cmd="docker run --rm -ti ezodoo/alpine-nginx-full:latest"
